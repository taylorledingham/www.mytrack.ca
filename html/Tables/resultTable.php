...
?>
		<tr id="<?php echo "Result" . $temp_result_id ?>">
			<td>				
				<form  style='display:inline;' id="<?php echo "editResult" . $temp_enrollment_id ?>" method="post" action="">
					<input type="hidden" name="result_id" value="<?php echo $temp_enrollment_id ?>" >
					<input type="submit" id="<?php echo 'button' . $temp_enrollment_id ?>" name="submit" value="Edit" class="button-edit">
				</form>
				
				<form  style='display:inline;' id="<?php echo "deleteResult" . $temp_enrollment_id ?>" method="post" action="">
					<input type="hidden" name="result_id" value="<?php echo $temp_enrollment_id ?>" >
					<input type="submit" id="<?php echo 'button' . $temp_enrollment_id ?>" name="submit" value="Edit" class="button-delete">
				</form>
			</td>
