...
//{
	...
	if(!$db){
		...
		$q = "SELECT E.* FROM Event E, AgeGroup AG WHERE E.ManagerID='$managerID' AND E.AgeGroup = AG.AgeGroupLong ORDER BY AG.Sort ASC";
...
<ul id="menu">    
   ...
   <li><a href="http://www.mytrack.ca/EditRecords.php" class="selected">Records</a></li> 
